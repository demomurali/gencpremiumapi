...
//delete a particular customer according to id	
...
//search for a customer according to age
...
//search for a customer according to mobile
	@GetMapping(value ="customers/mobile/{mobile}")
	public List<Customer> findByMobile(@PathVariable int mobile){
		List<Customer> customers = repository.findByMobile(mobile);
		return customers;
	}
